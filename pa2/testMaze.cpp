...
TEST_CASE("treasureMap::basic no cycles", "[weight=1][part=treasureMap]")
{
    ...
    cout<<"before treasureMap"<<endl;
    treasureMap M(base, maze, start);
    cout<<"after treasureMap"<<endl;
    PNG treasure = M.renderMap();
    cout<<"after renderMap"<<endl;
	treasure.writeToFile("images/renderMapTest.png");
    PNG treasureans;
    treasureans.readFromFile("images/embeddedsnake.png");
    REQUIRE( treasure == treasureans );

    PNG treasuremaze = M.renderMaze();
    treasuremaze.writeToFile("images/renderMazeTest.png");
    PNG treasuremazeans;
    ...
    soln.writeToFile("images/Testsolnsnake.png");
    PNG solnans;
    solnans.readFromFile("images/solnsnake.png");
    REQUIRE( soln == solnans );

    PNG solnmaze = dec.renderMaze();
    solnmaze.writeToFile("images/DecoderRenderMazeTest.png");
    PNG solnmazeans;
...
TEST_CASE("decoder::basic cycles", "[weight=1][part=decoder]")
{
    ...
    PNG soln = dec.renderSolution();
    soln.writeToFile("images/Testsolnmaze.png");
    PNG solnans;
    solnans.readFromFile("images/solnmaze.png");
    REQUIRE( soln == solnans );

    PNG solnmaze = dec.renderMaze();
    solnmaze.writeToFile("images/Rendersolnmazemaze.png");
    PNG solnmazeans;
